...
let
  gtkCss = ''
    ...
    @define-color headerbar_shade_color rgba(${theme.colorScheme.background1RGB}, ${theme.colorScheme.transparencyHeavyShadeHex});
    @define-color card_bg_color rgba(${theme.colorScheme.foreground1RGB}, ${theme.colorScheme.transparencyLightShadeHex});
    @define-color card_fg_color #${theme.colorScheme.foreground1Hex};
    @define-color card_shade_color rgba(${theme.colorScheme.background1RGB}, ${theme.colorScheme.transparencyHeavyShadeHex});
    ...
    @define-color shade_color rgba(${theme.colorScheme.background1RGB}, ${theme.colorScheme.transparencyHeavyShadeHex});
    @define-color scrollbar_outline_color rgba(${theme.colorScheme.background1RGB}, ${theme.colorScheme.transparencyHeavyShadeHex});
